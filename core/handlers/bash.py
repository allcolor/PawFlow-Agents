...
class BashHandler(BaseFsHandler):
    ...
    def description(self):
        return (
            ...
            " - Edit files: edit for ONE replacement. apply_patch as soon as you touch 3+ places in the same file, or a file you already edited this turn. batch_edit when the same change repeats across several files. write only when creating or fully replacing a file.\n"
            " - Write files: Use write (NOT echo >/cat <<EOF). A heredoc body "
            ...
            "exits or a regex matches, up to 10 minutes. Never poll a log "
            "file with 'sleep N; tail'.\n"
