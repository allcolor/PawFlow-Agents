...
The naming/path/config helper functions live in core/_relay_naming.py (split to
keep files <=800 lines); this module keeps the ServerRelayManager class. The
core.server_relay_manager import path is unchanged.
"""
...
from core._relay_naming import (
    ...
    _KIND_WORKSPACE,
    _cfg,
    _chown_for_host_runner,
    _container_name,
    _metadata_key,
    _prepare_relay_code_dir,
    _relay_container_name,
    _relay_id_for_conv,
    _relay_kind_config,
    _relay_runtime_dir,
    _relay_runtime_dir_for_scope,
    _relay_runtime_host_dir,
    _relay_volume_name,
    _validate_kind,
    _volume_name,
)
