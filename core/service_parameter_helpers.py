...
OPENAI_BASE_URLS = [
    ...
    ("Local relay", "http://${conv.relay}/localhost:1234/v1", "Relay-routed local OpenAI-compatible server."),
]
...
LOCAL_BASE_URLS = [
    ("Relay localhost 8000", "http://${conv.relay}/localhost:8000", "Relay-routed local HTTP endpoint."),
    ("Relay localhost 7788", "http://${conv.relay}/localhost:7788", "Common Supertonic local endpoint."),
    ("Relay localhost 17493", "http://${conv.relay}/localhost:17493", "Common Voicebox local endpoint."),
]
...
RCLONE_ENDPOINTS = [("https://s3.amazonaws.com", "AWS global endpoint."), ("https://<accountid>.r2.cloudflarestorage.com", "Cloudflare R2 endpoint template."), ("http://${conv.relay}/localhost:9000", "Relay-routed MinIO endpoint.")]
    ...
    *,
    ...
    if helper_id == "secrets.refs":
        ...
        if parameter == "provider":
            ...
            values = _values([("https://example.org/webdav", "WebDAV endpoint template."), ("http://${conv.relay}/localhost:8080", "Relay-routed WebDAV endpoint.")])
        elif parameter == "host":
