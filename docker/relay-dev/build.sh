...
# Cleanup
rm -f "$SCRIPT_DIR/pawflow_relay.py" "$SCRIPT_DIR/fs_common.py" "$SCRIPT_DIR/fs_actions.py" "$SCRIPT_DIR/fs_exec.py" "$SCRIPT_DIR/fs_screen.py" "$SCRIPT_DIR/fs_mcp.py" "$SCRIPT_DIR/pawflow.py" "$SCRIPT_DIR/audio_capture.py"
