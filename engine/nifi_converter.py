...
# Mapping tables and result dataclasses live in _nifi_types to keep this
# module <=800 lines; re-exported so engine.nifi_converter stays the public path.
from engine._nifi_types import (  # noqa: F401
    PROCESSOR_MAP,
    PROCESSOR_SHORT_MAP,
    RELATIONSHIP_MAP,
    SERVICE_MAP,
