...
from services.wavespeed_capability_services import (
    WaveSpeed3DService, WaveSpeedLipsyncService, WaveSpeedTrainerService,
    WaveSpeedTryOnService, WaveSpeedUpscaleService,
)
...
CLASSES = {
    "image": (WaveSpeedImageService, "image"),
    "video": (WaveSpeedVideoService, "video"),
    "audio": (WaveSpeedAudioService, "audio"),
    "voice-clone": (WaveSpeedVoiceCloneService, "audio"),
    "3d": (WaveSpeed3DService, "model"),
    "upscale": (WaveSpeedUpscaleService, "image"),
    "try-on": (WaveSpeedTryOnService, "image"),
    "lipsync": (WaveSpeedLipsyncService, "video"),
    "trainer": (WaveSpeedTrainerService, "data"),
}
