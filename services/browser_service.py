...
Config env vars:
    PAWFLOW_BROWSER_TIMEOUT: Session inactivity timeout (default: 300s)
    PAWFLOW_BROWSER_ALLOWED_DOMAINS: Comma-separated allowlist (empty = all)
    PAWFLOW_BROWSER_BLOCKED_DOMAINS: Comma-separated blocklist
"""
