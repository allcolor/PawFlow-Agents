...
from services._telegram_send import (  # noqa: F401 -- re-exported / patch targets
    _API_HOST,
    _TELEGRAM_TEXT_LIMIT,
    _TELEGRAM_SPLIT_LIMIT,
    _api_call_static,
    _send_channel,
    _close_send_conn,
    _parse_retry_after,
    _send_api_call,
    _reset_send_channels,
    _split_telegram_text,
    _split_telegram_plain,
    _best_telegram_split,
    _tokenize_html,
    _text_cut,
