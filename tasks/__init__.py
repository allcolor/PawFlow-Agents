...
def _register_all_services():
    ...
    import services.gating_service           # noqa: F401
    ...
    import services.llm_router                # noqa: F401
...
def register_all_tasks():
    ...
    from tasks.ai.workflow import (  # noqa: F401
        ...
        AppendMediaRevisionTask, ApplyCrawlDecisionTask, ApplyInventoryDecisionTask,
        ApplyWebsiteDecisionTask, ApplyWikiPatchTask, BuildWebsitePageBatchTask,
        CorrectWebsitePageBatchTask, DownloadTemplateTask, FinalizeStaticSiteTask,
        CompleteAgentTurnTask, EmitAgentProgressTask, FetchWikiSourcesTask,
        FetchSiteCrawlEntryTask, FormatMediaStudioResultTask,
        ...
        InitializeSiteCrawlTask, MapWebsitePageBatchTask,
        MergeWebsiteBuildTask, MergeWebsiteCorrectionTask,
        MergeWebsiteMappingTask, MergeWikiExtractionsTask, NormalizeProjectSourcesTask,
        PrepareMediaBriefTask, PrepareMediaIntentTask,
        PrepareMediaProvisioningTask, PrepareMediaQuestionsTask,
        PrepareMediaScenarioTask, PrepareCrawlDecisionTask,
        PrepareInventoryDecisionTask, PrepareWebsiteBuildBatchesTask,
        PrepareWebsiteCorrectionBatchesTask, PrepareWebsiteDecisionTask,
        PrepareWebsiteMappingBatchesTask, PrepareWebsiteRequestTask, PrepareWikiIntentTask,
        PrepareWikiReviewTask, ResolveMediaReferencesTask,
        RouteMediaIntentTask, RouteSiteCrawlTask, RouteWebsiteBatchesTask,
        RouteWikiIntentTask,
