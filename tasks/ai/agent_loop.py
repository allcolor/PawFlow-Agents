...
# Re-exported for back-compat: tests/callers import it from tasks.ai.agent_loop
from core.interrupt_policy import SOFT_INTERRUPT_USER_COMMAND  # noqa: F401,E402
...
from tasks.ai._agent_interrupt import _AgentInterruptMixin  # noqa: E402


class AgentLoopTask(
    _AgentInterruptMixin,
    AgentActionsMixin,
    AgentStreamingMixin,
    AgentCoreMixin,
