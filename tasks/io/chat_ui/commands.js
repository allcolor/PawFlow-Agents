...
const _LOCAL_COMMANDS = new Set([
  ...
  '/files', '/flows', '/tasks', '/confirmations', '/graph', '/wiki', '/scratchpad', '/scratchdir', '/kg',
  '/login',
...
const _CMD_HANDLERS = {
  ...
  '/confirmations': (text, parts, cmd) => cmdConfirmations(),
  ...
  '/scratchdir':    (text, parts, cmd) => cmdScratchDir(text, parts),
