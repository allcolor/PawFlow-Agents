...
class TestReadCycle(_FsCase):
    ...
    def test_release_waits_for_inflight_read(self):
        ...
        opened = self.fs.handle(
            "ffs.open", {"path": path, "flags": os.O_RDONLY})
        fh = opened["data"]["fh"]
