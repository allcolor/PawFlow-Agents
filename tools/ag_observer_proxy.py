...
# Semantic extractors live in ag_observer_semantics (split for <=800 lines).
# Re-exported here so the observer classes can call them as bare names and
# `tools.ag_observer_proxy.<helper>` keeps working for callers/tests.
try:  # standalone: /opt/pawflow on sys.path
    from ag_observer_semantics import (  # noqa: F401
        _redact_header, _extract_text_values, _semantic_model_delta, _latest_request_tool_results, _extract_tool_output_texts, _looks_like_tool_output, _standard_tool_results, _semantic_user_prompt, _stable_tool_id, _json_dict, _clean_name_part, _normalize_tool_call, _tool_result_content, _extract_tool_calls, _extract_tool_results, _extract_thinking_values, _extract_usage, _extract_finish_reason, _json_shape)
except ImportError:  # imported as tools.ag_observer_proxy
    from tools.ag_observer_semantics import (  # noqa: F401
        _redact_header, _extract_text_values, _semantic_model_delta, _latest_request_tool_results, _extract_tool_output_texts, _looks_like_tool_output, _standard_tool_results, _semantic_user_prompt, _stable_tool_id, _json_dict, _clean_name_part, _normalize_tool_call, _tool_result_content, _extract_tool_calls, _extract_tool_results, _extract_thinking_values, _extract_usage, _extract_finish_reason, _json_shape)
